...
Постійна кнопка прямо у верхній зоні каналу залежить від можливостей клієнта Telegram і типу прив'язки бота до каналу. Якщо Telegram не показує таку кнопку для каналу, найближчий надійний варіант - закріплений пост або кнопка під постом.
